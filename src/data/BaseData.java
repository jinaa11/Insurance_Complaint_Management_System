...
public class BaseData {
    ...
    public void generateGeneralInitDate(SystemManager manager) {
        List<User> users = List.of(
                ...
                new Business("사업장1", "980303", "010-1234-1233", "9803031234567", 1001, "현수진기업"),
                new Business("사업장2", "970302", "010-5465-2432", "9703026342346", 1002, "테크맥"),
                new Business("사업장3", "990301", "010-1234-1233", "9903011234567", 1003, "빅빅빅빅빅"),
                new Business("사업장4", "990301", "010-1234-1233", "9903011234567", 1004, "카카오"),
                new Business("사업장5", "990301", "010-1234-1233", "9903011234567", 1005, "네이버"),
                new Business("사업장6", "990301", "010-1234-1233", "9903011234567", 1006, "페이스북"),
...
//        systemManager.getTreatmentManager().showMedicalTreatmentsByGeneral(general);
    ...
    public static List<MedicalDevice> genenrateMedicalDevices() {
        return List.of(
                ...
                new MedicalDevice(ItemCode.THERAPEUTIC_DEVICE, "적외선 램프", 5),
