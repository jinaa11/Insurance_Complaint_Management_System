...
public class Qualification {
    ...
    public Qualification(General general, LocalDate acquireDate, LocalDate lossDate) {
    ...
    public void showDetail() {
        ...
        System.out.println();
        System.out.println("< 조회결과 >" + "\t" + "기준일");
        System.out.println("건강보험증번호 : " + general.getInsuranceNumber());
        System.out.println("사업장명 : " + general.getWorkInfo().getBid() + "/" + "가입자 구분 : " +  relationship);
        if (lossDate == null) {
    ...
    public void showRelationShip() {
        ...
        System.out.println("주민등록번호 : " + general.getResidentNumber());
        System.out.println();
        System.out.println("< 자격득실내역 >" + "기준일 : " + todayString);
        System.out.println("가입자 구분: " + relationship);
        System.out.println("사업장명 : " + general.getWorkInfo().getBname());
        System.out.println("취득일 : " + acquireDate);
        System.out.println("상실일 : " + lossDate);
        System.out.println("===================================================================");
